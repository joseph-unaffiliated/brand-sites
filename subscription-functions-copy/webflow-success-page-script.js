...
function executeSubscriptionAction(actionOverride = null) {
  ...
  function showRetryButton(element) {
    if (!element) return;
    
    // Check if retry button already exists
    if (element.parentElement.querySelector('.retry-button')) return;
    
    const retryBtn = document.createElement('button');
    retryBtn.className = 'retry-button';
    retryBtn.textContent = 'Try Again';
    retryBtn.style.cssText = 'margin-top: 16px; padding: 12px 24px; background: #007bff; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 16px;';
  ...
  buttons.forEach(button => {
    ...
    button.addEventListener('click', function(e) {
      ...
      if (buttonId === 'unsub-resub') {
        targetUrl = `https://magic.{{wf {&quot;path&quot;:&quot;slug&quot;,&quot;type&quot;:&quot;PlainText&quot;\} }}.com/?email=${encodeURIComponent(email)}`;
        console.log('🔄 Resubscribing to brand:', targetUrl);
      } else if (buttonId === 'unsub-snooze') {
        targetUrl = `https://magic.{{wf {&quot;path&quot;:&quot;slug&quot;,&quot;type&quot;:&quot;PlainText&quot;\} }}.com/snooze?email=${encodeURIComponent(email)}`;
  ...
  form.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      const params = new URLSearchParams({
        email: email,
        brand: '{{wf {&quot;path&quot;:&quot;slug&quot;,&quot;type&quot;:&quot;PlainText&quot;\} }}',
