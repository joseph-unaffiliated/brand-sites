# The Pickle Report — issue paste template (matches Google Doc export)
...
IMAGE (link to image in Header Image drive)

Issue 19 Header Image
...
PICKLE ECONOMICS TITLE
Map of Pickle Cucumber Growing in U.S.

GRAPH (link to image in Pickle Graphs drive)
...
GRAPH INFORMATION URL
https://www.canr.msu.edu/cea/uploads/files/us%20fresh%20pickling%20cucumber%20markets.pdf

NIBBLES (secondary sources)

Source 1
Blurb: 100 years ago, 13 neighbors pooled $19,500 to save surplus cucumbers. Now they sell 230 million jars a year.
Link: https://www.mtolivepickles.com/celebrating-100-years-of-mt-olive-pickle-company-a-century-at-the-corner-of-cucumber-vine/
Source: Mt. Olive

Source 2
Blurb: The birthrate was dropping in 1974. Vlasic saw an opportunity — and a stork got a new job.
Link: https://www.mentalfloss.com/article/64109/why-vlasic-pickles-mascot-stork
Source: Mental Floss

Source 3
Blurb: Bubbies just solved the messiest problem in snacking: the pickle. Meet the first clean-label, grab-and-go pouch.
Link: https://finance.yahoo.com/news/bubbies-redefines-snacking-pickle-first-163500018
Source: Yahoo

SEXY PIC(KLE) OF THE WEEK (link to image in Sexy Pic(kle) drive)

Issue 19 Sexy Pic(kle)

SEXY PIC(KLE) OF THE WEEK IMAGE SOURCE
Pinterest (@robynclayton)

TODAY'S PICKLE TRIVIA (answer highlighted in yellow)

Question: Of the four brands in today's article, which one must be kept refrigerated even before opening?

Options (order = A, B, C, D for email links — labels only in Studio):
Vlasic
Bubbies
Claussen
Mt. Olive

LAST WEEK'S PICKLE TRIVIA (answer highlighted in yellow)

Question: Which of these items is NOT on the KFC UK Pickled Menu?
