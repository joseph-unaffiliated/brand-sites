/**
 * Hipspeak cross-promo: house ads for other network brands only. Never point at
 * Hipspeak creatives (none exist yet; and hosts shouldn't self-promo). Currently
 * rotates The Pickle Report + The '90s Parent from shared-ads.
 */
