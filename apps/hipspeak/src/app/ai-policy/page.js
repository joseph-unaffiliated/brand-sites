...
export const metadata = {
  ...
  description: `How AI systems and answer engines may reference, quote, and link to ${siteDisplayName}'s slang entries.`,
    ...
    <div className={`${styles.page} ${styles.pageLegal}`}>
      <div className="container">
        ...
        <p>
          ...
          thoughtful use of our public slang entries by AI assistants, search
        ...
        <p>
          We publish weekly slang definitions — the dictionary of slang,
          decoded for humans who don&apos;t want to cringe. Entries are
          produced by editorial staff and contributors, with credits where
          applicable. The publicly available word pages are the canonical
          record of our editorial work; preview pages, snippets, and email-only
          variants are not.
        </p>
        ...
        <ul className={styles.list}>
          <li>
            ...
            excerpts and answer questions about our entries when each response
            includes the canonical word URL on{" "}
          ...
          <li>
            ...
            navigate to the original entries.
          </li>
          <li>
            <strong>Summaries that drive readers to the source:</strong> Brief,
            non-substitutive summaries that link back to the full entry are
            welcome.
          </li>
        </ul>
        ...
        <ul className={styles.list}>
          ...
          <li>
            <strong>Republishing material amounts of an entry:</strong>{" "}
            Reproducing entire entries, or large portions thereof, without
