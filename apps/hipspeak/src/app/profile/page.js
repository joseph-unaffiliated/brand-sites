...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const sync = () => setMyWordsCount(getFavoriteSlugs().length);
    sync();
  ...
  return (
    <div className={styles.wrap}>
      ...
      <section className={styles.section}>
        ...
        {subscribedAt && (
          <p className={styles.accountLine}>
            <strong>Subscribed to {siteDisplayName} since:</strong> {formatDate(subscribedAt) ?? subscribedAt}
          </p>
        )}
        <p className={styles.accountLine}>
      ...
      <section className={styles.section}>
        ...
        {loading ? (
          ...
          <p className={styles.error}>Could not load subscriptions. You can still manage {siteDisplayName} below.</p>
        ) : null}
        {!loading && (
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>My words</h2>
        <p className={styles.accountLine}>
          <strong>Saved:</strong> {myWordsCount} word{myWordsCount === 1 ? "" : "s"}
        </p>
        <p className={styles.accountLine}>
          <Link href="/my-words">View your words</Link>
        </p>
      </section>
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>Words you&apos;ve read</h2>
