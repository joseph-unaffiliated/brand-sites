...
function articleUrlForBrand(brandId, slug, brandById, currentBrandId) {
  if (brandId === currentBrandId) return `/recipe/${slug}`;
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const sync = () => setFavoriteCount(getFavoriteSlugs().length);
    sync();
  ...
  return (
    <div className={styles.wrap}>
      ...
      <section className={styles.section}>
        ...
        {subscribedAt && (
          <p className={styles.accountLine}>
            <strong>Subscribed to The Eyeballer&apos;s Cookbook since:</strong> {formatDate(subscribedAt) ?? subscribedAt}
          </p>
        )}
        <p className={styles.accountLine}>
      ...
      <section className={styles.section}>
        ...
        {loading ? (
          ...
          <p className={styles.error}>Could not load subscriptions. You can still manage The Eyeballer&apos;s Cookbook below.</p>
        ) : null}
        {!loading && (
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>Favorite recipes</h2>
        <p className={styles.accountLine}>
          <strong>Saved:</strong> {favoriteCount} recipe{favoriteCount === 1 ? "" : "s"}
        </p>
        <p className={styles.accountLine}>
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>Recipes you&apos;ve viewed</h2>
