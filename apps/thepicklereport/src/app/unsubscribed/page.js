...
function UnsubscribedContent() {
  ...
  function handleFeedback() {
    ...
    window.location.href = `mailto:contact@thepicklereport.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  }
  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.card}>
        ...
        {status === 'done' && (
          <p className={styles.body}>We&apos;re sorry to see you go. You&apos;ve been removed from The Pickle Report.</p>
        )}
        {status === 'error' && (
        ...
        {email && (
          <div className={styles.actions}>
            <a
              ...
              href={`https://magic.thepicklereport.com/?email=${encodeURIComponent(email)}`}
            >
              Resubscribe
            </a>
            <a
              className="button button-secondary"
              href={`https://magic.thepicklereport.com/snooze?email=${encodeURIComponent(email)}`}
            >
              Snooze instead
            </a>
          </div>
