  ...
  return (
    <div className={`${styles.page} ${styles.pageLegal}`}>
      <div className="container">
        ...
        <p>
          We publish weekly pickle news, culture, and commentary — salty,
          crunchy coverage for people who take pickles seriously (and those who
          don&apos;t). Articles are produced by editorial staff and
          contributors, with credits where applicable. The publicly available
          articles are the canonical record of our editorial work; preview
          pages, snippets, and email-only variants are not.
        </p>
