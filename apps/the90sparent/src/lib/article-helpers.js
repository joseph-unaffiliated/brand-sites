...
/**
 * Lowercased corpus for archive search: title, dek, summary, byline, tags,
 * and all text from content blocks (feature body, examples, captions, around-the-web, etc.).
 */
export function searchTextFromArticle(article) {
  ...
  collectSearchableStrings(article?.sourceLinks, parts);
  return parts
