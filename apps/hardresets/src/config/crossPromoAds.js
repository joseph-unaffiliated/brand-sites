/**
 * Hard Resets cross-promo: The Pickle Report + The '90s Parent image ads only.
 * Each placement picks a brand from `packages/shared-ads` and its click-through URL.
 */
